...
var or__4131__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71535_SHARP_){
return p1__71535_SHARP_.length();
}),cljs.core.keys(m))));
...
return (function (p__71539){
var vec__71540 = p__71539;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71540,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71540,(1),null);
var len = k.length();
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71543_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__71543_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["PConstants/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(quil.util.prepare_quil_name(p1__71543_SHARP_))].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71544_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__71544_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,cljs.core.cst$sym$cljs$core_SLASH_aget,null,(1),null)),(new cljs.core.List(null,cljs.core.cst$sym$js_SLASH_p5$prototype,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,quil.util.prepare_quil_name(p1__71544_SHARP_),null,(1),null))], 0))))],null));
}),constants));
});
...
var ret__4776__auto___71550 = (function (){
quil.util.generate_quil_constants = (function quil$util$generate_quil_constants(var_args){
var args__4736__auto__ = [];
var len__4730__auto___71551 = arguments.length;
var i__4731__auto___71552 = (0);
while(true){
if((i__4731__auto___71552 < len__4730__auto___71551)){
args__4736__auto__.push((arguments[i__4731__auto___71552]));

var G__71553 = (i__4731__auto___71552 + (1));
i__4731__auto___71552 = G__71553;
continue;
} else {
}
break;
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,cljs.core.cst$sym$do,null,(1),null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__71545_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__71545_SHARP_),cljs.core.second(p1__71545_SHARP_));
...
/** @this {Function} */
quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq71546){
var G__71547 = cljs.core.first(seq71546);
var seq71546__$1 = cljs.core.next(seq71546);
var G__71548 = cljs.core.first(seq71546__$1);
var seq71546__$2 = cljs.core.next(seq71546__$1);
var G__71549 = cljs.core.first(seq71546__$2);
var seq71546__$3 = cljs.core.next(seq71546__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71547,G__71548,G__71549,seq71546__$3);
});
