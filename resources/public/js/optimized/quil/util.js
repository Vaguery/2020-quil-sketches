...
var or__4131__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55251_SHARP_){
return p1__55251_SHARP_.length();
}),cljs.core.keys(m))));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55259_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__55259_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["PConstants/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(quil.util.prepare_quil_name(p1__55259_SHARP_))].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55260_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__55260_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,cljs.core.cst$sym$cljs$core_SLASH_aget,null,(1),null)),(new cljs.core.List(null,cljs.core.cst$sym$js_SLASH_p5$prototype,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,quil.util.prepare_quil_name(p1__55260_SHARP_),null,(1),null))], 0))))],null));
}),constants));
});
...
var ret__4776__auto___55266 = (function (){
...
var i__4731__auto___55268 = (0);
while(true){
if((i__4731__auto___55268 < len__4730__auto___55267)){
args__4736__auto__.push((arguments[i__4731__auto___55268]));

var G__55269 = (i__4731__auto___55268 + (1));
i__4731__auto___55268 = G__55269;
continue;
} else {
}
break;
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,cljs.core.cst$sym$do,null,(1),null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55261_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__55261_SHARP_),cljs.core.second(p1__55261_SHARP_));
...
/** @this {Function} */
quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq55262){
var G__55263 = cljs.core.first(seq55262);
var seq55262__$1 = cljs.core.next(seq55262);
var G__55264 = cljs.core.first(seq55262__$1);
var seq55262__$2 = cljs.core.next(seq55262__$1);
var G__55265 = cljs.core.first(seq55262__$2);
var seq55262__$3 = cljs.core.next(seq55262__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55263,G__55264,G__55265,seq55262__$3);
});
