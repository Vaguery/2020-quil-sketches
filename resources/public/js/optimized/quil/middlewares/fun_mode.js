...
return (function (){
var G__71972 = cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(quil.core.state_atom(),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(quil.core.frame_count(),(1)))?cljs.core.identity:update));
return (draw.cljs$core$IFn$_invoke$arity$1 ? draw.cljs$core$IFn$_invoke$arity$1(G__71972) : draw.call(null,G__71972));
});})(draw,update))
;
...
var len__4730__auto___71978 = arguments.length;
var i__4731__auto___71979 = (0);
while(true){
if((i__4731__auto___71979 < len__4730__auto___71978)){
args__4736__auto__.push((arguments[i__4731__auto___71979]));

var G__71980 = (i__4731__auto___71979 + (1));
i__4731__auto___71979 = G__71980;
continue;
} else {
}
break;
...
/** @this {Function} */
quil.middlewares.fun_mode.wrap_handlers.cljs$lang$applyTo = (function (seq71976){
var G__71977 = cljs.core.first(seq71976);
var seq71976__$1 = cljs.core.next(seq71976);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__71977,seq71976__$1);
});
