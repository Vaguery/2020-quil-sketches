...
var vec__27634 = axis;
var a_x = cljs.core.nth.call(null,vec__27634,(0),null);
var a_y = cljs.core.nth.call(null,vec__27634,(1),null);
var a_z = cljs.core.nth.call(null,vec__27634,(2),null);
var vec__27637 = v;
var x = cljs.core.nth.call(null,vec__27637,(0),null);
var y = cljs.core.nth.call(null,vec__27637,(1),null);
var z = cljs.core.nth.call(null,vec__27637,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__27640,p__27641){
var vec__27642 = p__27640;
var u1 = cljs.core.nth.call(null,vec__27642,(0),null);
var u2 = cljs.core.nth.call(null,vec__27642,(1),null);
var u3 = cljs.core.nth.call(null,vec__27642,(2),null);
var vec__27645 = p__27641;
var v1 = cljs.core.nth.call(null,vec__27645,(0),null);
var v2 = cljs.core.nth.call(null,vec__27645,(1),null);
var v3 = cljs.core.nth.call(null,vec__27645,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__27648_SHARP_){
return (p1__27648_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__27649_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__27650_SHARP_,angle_lr),angle_ud);
...
var map__27652 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__27652__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__27652__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__27654 = cljs.core._EQ_;
var expr__27655 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__27654.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__27655))){
return straight;
} else {
if(cljs.core.truth_(pred__27654.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__27655))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__27654.call(null,quil.middlewares.navigation_3d.space,expr__27655))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__27654.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__27655))){
return up;
} else {
if(cljs.core.truth_(pred__27654.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__27655))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__27654.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__27655))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__27652,map__27652__$1,up,straight){
return (function (p1__27651_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__27651_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__27652,map__27652__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__27657_SHARP_);
});})(initial_state))
);
});
/**
...
var map__27658_27669 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__27658_27670__$1 = (((((!((map__27658_27669 == null))))?(((((map__27658_27669.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27658_27669.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27658_27669):map__27658_27669);
var vec__27659_27671 = cljs.core.get.call(null,map__27658_27670__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_27672 = cljs.core.nth.call(null,vec__27659_27671,(0),null);
var c_y_27673 = cljs.core.nth.call(null,vec__27659_27671,(1),null);
var c_z_27674 = cljs.core.nth.call(null,vec__27659_27671,(2),null);
var vec__27662_27675 = cljs.core.get.call(null,map__27658_27670__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_27676 = cljs.core.nth.call(null,vec__27662_27675,(0),null);
var u_y_27677 = cljs.core.nth.call(null,vec__27662_27675,(1),null);
var u_z_27678 = cljs.core.nth.call(null,vec__27662_27675,(2),null);
var vec__27665_27679 = cljs.core.get.call(null,map__27658_27670__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_27680 = cljs.core.nth.call(null,vec__27665_27679,(0),null);
var p_y_27681 = cljs.core.nth.call(null,vec__27665_27679,(1),null);
var p_z_27682 = cljs.core.nth.call(null,vec__27665_27679,(2),null);
quil.core.camera.call(null,p_x_27680,p_y_27681,p_z_27682,(p_x_27680 + c_x_27672),(p_y_27681 + c_y_27673),(p_z_27682 + c_z_27674),u_x_27676,u_y_27677,u_z_27678);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1581343825728
