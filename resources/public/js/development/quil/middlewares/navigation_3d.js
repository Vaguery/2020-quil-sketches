...
var vec__59360 = axis;
var a_x = cljs.core.nth.call(null,vec__59360,(0),null);
var a_y = cljs.core.nth.call(null,vec__59360,(1),null);
var a_z = cljs.core.nth.call(null,vec__59360,(2),null);
var vec__59363 = v;
var x = cljs.core.nth.call(null,vec__59363,(0),null);
var y = cljs.core.nth.call(null,vec__59363,(1),null);
var z = cljs.core.nth.call(null,vec__59363,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__59366,p__59367){
var vec__59368 = p__59366;
var u1 = cljs.core.nth.call(null,vec__59368,(0),null);
var u2 = cljs.core.nth.call(null,vec__59368,(1),null);
var u3 = cljs.core.nth.call(null,vec__59368,(2),null);
var vec__59371 = p__59367;
var v1 = cljs.core.nth.call(null,vec__59371,(0),null);
var v2 = cljs.core.nth.call(null,vec__59371,(1),null);
var v3 = cljs.core.nth.call(null,vec__59371,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__59374_SHARP_){
return (p1__59374_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return (function (p1__59375_SHARP_){
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__59375_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__59376_SHARP_,angle_lr),angle_ud);
...
var map__59378 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__59378__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__59378__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__59380 = cljs.core._EQ_;
var expr__59381 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__59380.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__59381))){
return straight;
} else {
if(cljs.core.truth_(pred__59380.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__59381))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__59380.call(null,quil.middlewares.navigation_3d.space,expr__59381))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__59380.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__59381))){
return up;
} else {
if(cljs.core.truth_(pred__59380.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__59381))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__59380.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__59381))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__59378,map__59378__$1,up,straight){
return (function (p1__59377_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__59377_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__59378,map__59378__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__59383_SHARP_);
});})(initial_state))
);
});
/**
...
var map__59384_59395 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__59384_59396__$1 = (((((!((map__59384_59395 == null))))?(((((map__59384_59395.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__59384_59395.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__59384_59395):map__59384_59395);
var vec__59385_59397 = cljs.core.get.call(null,map__59384_59396__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_59398 = cljs.core.nth.call(null,vec__59385_59397,(0),null);
var c_y_59399 = cljs.core.nth.call(null,vec__59385_59397,(1),null);
var c_z_59400 = cljs.core.nth.call(null,vec__59385_59397,(2),null);
var vec__59388_59401 = cljs.core.get.call(null,map__59384_59396__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_59402 = cljs.core.nth.call(null,vec__59388_59401,(0),null);
var u_y_59403 = cljs.core.nth.call(null,vec__59388_59401,(1),null);
var u_z_59404 = cljs.core.nth.call(null,vec__59388_59401,(2),null);
var vec__59391_59405 = cljs.core.get.call(null,map__59384_59396__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_59406 = cljs.core.nth.call(null,vec__59391_59405,(0),null);
var p_y_59407 = cljs.core.nth.call(null,vec__59391_59405,(1),null);
var p_z_59408 = cljs.core.nth.call(null,vec__59391_59405,(2),null);
quil.core.camera.call(null,p_x_59406,p_y_59407,p_z_59408,(p_x_59406 + c_x_59398),(p_y_59407 + c_y_59399),(p_z_59408 + c_z_59400),u_x_59402,u_y_59403,u_z_59404);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1581380907206
