...
return cljs.core.merge.call(null,initial_state,p1__43271_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_43272 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_43273 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_43272);
var pos_43274 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_43272);
quil.core.scale.call(null,zoom_43273);

var tr__27402__auto___43275 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_43273) - cljs.core.first.call(null,pos_43274)),(((quil.core.height.call(null) / (2)) / zoom_43273) - cljs.core.second.call(null,pos_43274))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__27402__auto___43275);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1581079341364
