...
return cljs.core.merge.call(null,initial_state,p1__59411_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_59412 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_59413 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_59412);
var pos_59414 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_59412);
quil.core.scale.call(null,zoom_59413);

var tr__22205__auto___59415 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_59413) - cljs.core.first.call(null,pos_59414)),(((quil.core.height.call(null) / (2)) / zoom_59413) - cljs.core.second.call(null,pos_59414))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__22205__auto___59415);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1581380907253
