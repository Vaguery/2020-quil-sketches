...
return cljs.core.merge.call(null,initial_state,p1__27685_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_27686 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_27687 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_27686);
var pos_27688 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_27686);
quil.core.scale.call(null,zoom_27687);

var tr__21251__auto___27689 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_27687) - cljs.core.first.call(null,pos_27688)),(((quil.core.height.call(null) / (2)) / zoom_27687) - cljs.core.second.call(null,pos_27688))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__21251__auto___27689);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1581343825803
