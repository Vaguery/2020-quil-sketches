...
return (new CustomEvent(event_name,(function (){var obj63116 = ({"detail":data});
return obj63116;
})()));
} else {
...
var f = (function (){var pred__63123 = cljs.core._EQ_;
var expr__63124 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__63123.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__63124))){
return ((function (pred__63123,expr__63124){
return (function (p1__63117_SHARP_){
return console.warn(p1__63117_SHARP_);
});
;})(pred__63123,expr__63124))
} else {
if(cljs.core.truth_(pred__63123.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__63124))){
return ((function (pred__63123,expr__63124){
return (function (p1__63118_SHARP_){
return console.debug(p1__63118_SHARP_);
});
;})(pred__63123,expr__63124))
} else {
if(cljs.core.truth_(pred__63123.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__63124))){
return ((function (pred__63123,expr__63124){
return (function (p1__63119_SHARP_){
return console.error(p1__63119_SHARP_);
});
;})(pred__63123,expr__63124))
} else {
return ((function (pred__63123,expr__63124){
return (function (p1__63120_SHARP_){
return console.log(p1__63120_SHARP_);
});
;})(pred__63123,expr__63124))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__63127){
var map__63128 = p__63127;
var map__63128__$1 = (((((!((map__63128 == null))))?(((((map__63128.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63128.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63128):map__63128);
var opts = map__63128__$1;
var eval_fn = cljs.core.get.call(null,map__63128__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__63130_SHARP_);
});})(new_def))
);
...
return (function (p__63131){
var vec__63132 = p__63131;
var ky = cljs.core.nth.call(null,vec__63132,(0),null);
var v = cljs.core.nth.call(null,vec__63132,(1),null);
...
}catch (e63137){if((e63137 instanceof Error)){
var e = e63137;
return not_found;
} else {
throw e63137;
...
//# sourceMappingURL=utils.js.map?rel=1581380913119
