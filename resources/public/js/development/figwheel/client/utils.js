...
return (new CustomEvent(event_name,(function (){var obj31189 = ({"detail":data});
return obj31189;
})()));
} else {
...
var f = (function (){var pred__31196 = cljs.core._EQ_;
var expr__31197 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31196.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31197))){
return ((function (pred__31196,expr__31197){
return (function (p1__31190_SHARP_){
return console.warn(p1__31190_SHARP_);
});
;})(pred__31196,expr__31197))
} else {
if(cljs.core.truth_(pred__31196.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31197))){
return ((function (pred__31196,expr__31197){
return (function (p1__31191_SHARP_){
return console.debug(p1__31191_SHARP_);
});
;})(pred__31196,expr__31197))
} else {
if(cljs.core.truth_(pred__31196.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31197))){
return ((function (pred__31196,expr__31197){
return (function (p1__31192_SHARP_){
return console.error(p1__31192_SHARP_);
});
;})(pred__31196,expr__31197))
} else {
return ((function (pred__31196,expr__31197){
return (function (p1__31193_SHARP_){
return console.log(p1__31193_SHARP_);
});
;})(pred__31196,expr__31197))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31200){
var map__31201 = p__31200;
var map__31201__$1 = (((((!((map__31201 == null))))?(((((map__31201.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31201.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31201):map__31201);
var opts = map__31201__$1;
var eval_fn = cljs.core.get.call(null,map__31201__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31203_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31205,(0),null);
...
}catch (e31210){if((e31210 instanceof Error)){
var e = e31210;
return not_found;
} else {
throw e31210;
...
//# sourceMappingURL=utils.js.map?rel=1581096741696
