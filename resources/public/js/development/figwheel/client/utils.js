...
var f = (function (){var pred__27104 = cljs.core._EQ_;
var expr__27105 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27104.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27105))){
return ((function (pred__27104,expr__27105){
return (function (p1__27098_SHARP_){
return console.warn(p1__27098_SHARP_);
});
;})(pred__27104,expr__27105))
} else {
if(cljs.core.truth_(pred__27104.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27105))){
return ((function (pred__27104,expr__27105){
...
if(cljs.core.truth_(pred__27104.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27105))){
return ((function (pred__27104,expr__27105){
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27108){
var map__27109 = p__27108;
var map__27109__$1 = (((((!((map__27109 == null))))?(((((map__27109.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27109.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__27109):map__27109);
var opts = map__27109__$1;
var eval_fn = cljs.core.get.call(null,map__27109__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27111_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27113,(0),null);
var v = cljs.core.nth.call(null,vec__27113,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1581009604851
