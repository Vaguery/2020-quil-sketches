...
return (new CustomEvent(event_name,(function (){var obj32839 = ({"detail":data});
return obj32839;
})()));
} else {
...
var f = (function (){var pred__32846 = cljs.core._EQ_;
var expr__32847 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32846.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32847))){
return ((function (pred__32846,expr__32847){
return (function (p1__32840_SHARP_){
return console.warn(p1__32840_SHARP_);
});
;})(pred__32846,expr__32847))
} else {
if(cljs.core.truth_(pred__32846.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32847))){
return ((function (pred__32846,expr__32847){
return (function (p1__32841_SHARP_){
return console.debug(p1__32841_SHARP_);
});
;})(pred__32846,expr__32847))
} else {
if(cljs.core.truth_(pred__32846.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32847))){
return ((function (pred__32846,expr__32847){
return (function (p1__32842_SHARP_){
return console.error(p1__32842_SHARP_);
});
;})(pred__32846,expr__32847))
} else {
return ((function (pred__32846,expr__32847){
return (function (p1__32843_SHARP_){
return console.log(p1__32843_SHARP_);
});
;})(pred__32846,expr__32847))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32850){
...
var eval_fn = cljs.core.get.call(null,map__32851__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32853_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__32855,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1581343832427
