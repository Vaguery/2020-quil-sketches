...
return (new CustomEvent(event_name,(function (){var obj47013 = ({"detail":data});
return obj47013;
})()));
} else {
...
var f = (function (){var pred__47020 = cljs.core._EQ_;
var expr__47021 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__47020.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__47021))){
return ((function (pred__47020,expr__47021){
return (function (p1__47014_SHARP_){
return console.warn(p1__47014_SHARP_);
});
;})(pred__47020,expr__47021))
} else {
if(cljs.core.truth_(pred__47020.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__47021))){
return ((function (pred__47020,expr__47021){
return (function (p1__47015_SHARP_){
return console.debug(p1__47015_SHARP_);
});
;})(pred__47020,expr__47021))
} else {
if(cljs.core.truth_(pred__47020.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__47021))){
return ((function (pred__47020,expr__47021){
return (function (p1__47016_SHARP_){
return console.error(p1__47016_SHARP_);
});
;})(pred__47020,expr__47021))
} else {
return ((function (pred__47020,expr__47021){
return (function (p1__47017_SHARP_){
return console.log(p1__47017_SHARP_);
});
;})(pred__47020,expr__47021))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__47024){
...
var opts = map__47025__$1;
var eval_fn = cljs.core.get.call(null,map__47025__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__47027_SHARP_);
});})(new_def))
);
...
return (function (p__47028){
var vec__47029 = p__47028;
var ky = cljs.core.nth.call(null,vec__47029,(0),null);
var v = cljs.core.nth.call(null,vec__47029,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1581079345857
